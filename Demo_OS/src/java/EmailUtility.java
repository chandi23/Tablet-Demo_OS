...
public class EmailUtility {
	...
	public static void sendEmailWithAttachment(String host, String port,
		...
		properties.put("mail.user", "sharmaprateek223@gmail.com");
		properties.put("mail.password","ayush1234");
		...
		Authenticator auth = new Authenticator() {
			public PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("sharmaprateek223@gmail.com","ayush1234");
			}
		};
		...
		msg.setFrom(new InternetAddress("sharmaprateek223@gmail.com"
                ));
