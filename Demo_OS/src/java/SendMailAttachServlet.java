...
public class SendMailAttachServlet extends HttpServlet {
	...
	public void init() {
		...
		//pass = context.getInitParameter("pass");
                user="sharmaprateek223@gmail.com";
                pass="ayush1234";
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		String resultMessage = "";
               ...
               EmailContacts a = new EmailContacts(recipient);
                if(a.isNumeric()==true)
                {
                    recipient = a.retstring();
		...
		EmailDb axc = new EmailDb();
               axc.getcontent(subject,recipient,content);
               axc.setcontent();
		} catch (Exception ex) {
			ex.printStackTrace();
